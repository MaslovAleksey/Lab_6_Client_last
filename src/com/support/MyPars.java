...
public class MyPars
{
        ...
        while (true) {
            if (age_ob != null) {
                ...
                if ((isAge) && (d > 0)) {
                    ...
                    System.out.print("Возраст объекта " + nameSt + "  не соответствует требованиям, " +
                ...
                if (!isColor) {
                    switch (colorSt) {
                        ...
                        case "":
                            ...
                            break;
                        default:
                            System.out.print("Цвет объекта " + nameSt + " не соответствует требованиям, " +
     ...
     * @throws NoSuchElementException Отслеживание команды завершения пользовательского ввода
     */
    private void extractCoordinates (Object coordinates_ob, Dragon dopMyDragon)throws NoSuchElementException
    {
        ...
        while (true) {
            if (xOb != null) {
                ...
                if ((isX) && (d > -704)) {
                    ...
                    System.out.print("Значение координаты Х у объекта " + nameSt + " не соответствует требованиям," +
        ...
        while (true) {
            if (yOb != null) {
                ...
                if ((isY) && (d <= 28)) {
                    ...
                    System.out.print("Значение координаты Y у объекта " + nameSt + " не соответствует требованиям," +
     ...
     * @throws NoSuchElementException Отслеживание команды завершения пользовательского ввода
     */
    private void extractSpeaking (Object speaking_ob, Dragon dopMyDragon) throws NoSuchElementException
    {
        String speakingSt;
        boolean isSpeaking;
        ...
        while (true) {
            if (speaking_ob != null) {
                ...
                if ((!isSpeaking) && ((speakingSt.equals("true")) || (speakingSt.equals("false")))) {
                    ...
                    System.out.print("Способность разговаривать у объекта " + nameSt + "  не соответствует требованиям, " +
        ...
        while (true) {
            if ((depthOb != null) && (Empty(depthOb.toString()) != null)) {
                ...
                if (isDepth) {
                    ...
                    System.out.print("Значение поля depth у объекта " + nameSt + " не соответствует требованиям," +
        ...
        while (true) {
            if (numberOfTreasuresOb != null) {
                ...
                if ((d > 0) && (isNumberOfTreasures)) {
                    ...
                    System.out.print("Значение поля numberOfTreasures у объекта " + nameSt + " не соответствует требованиям," +
                ...
                if (!isType) {
                    switch (typeSt) {
                        ...
                        case "":
                            ...
                            break;
                        default:
                            System.out.print("Тип объекта " + nameSt + " не соответствует требованиям, " +
